...
function App() {
  ...
  const answers = [
    ...
    "Quer ser pra sempre a minha princesinha chata? A mulher da minha vida?"
  ]
          ...
          {currentAnswer < answers.length ? (
            ...
            <div className="flex flex-col items-center gap-4">
              <p className="font-semibold" align="center">"
                <b>Prometo te fazer a mulher mais feliz do mundo.</b> - Vini
              </p>

              <p align="center">Te amo bebê, meu ursinho fofoo</p>

              <img src={health} alt="" width={200} />

              <p className="mt-10">Feito por Vinii, dedicado a mucilon dele</p>
            </div>
          )
          }
        </div>
